...
export class ExerciseTypeComponent implements OnInit {
  ...
  trackId = (_index: number, item: IExerciseType): number => this.exerciseTypeService.getExerciseTypeIdentifier(item);
  ...
  protected refineData(data: IExerciseType[]): IExerciseType[] {
    return data.sort(this.sortService.startSort(this.predicate, this.ascending ? 1 : -1));
  }

  protected fillComponentAttributesFromResponseBody(data: IExerciseType[] | null): IExerciseType[] {
    return data ?? [];
  }
